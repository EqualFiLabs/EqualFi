...
/// @notice Property-based tests for agent registration integrity
/// forge-config: default.fuzz.runs = 100
contract PositionAgentRegistrationPropertyTest is Test {
    ...
    /// @notice **Feature: erc6551-position-agents, Property 4: Agent Registration Integrity**
    /// @notice After external registration, recordAgentRegistration stores mapping and emits event
    /// @notice **Validates: Requirements 3.1, 3.2, 3.3, 3.4, 11.2**
    function testProperty_AgentRegistrationIntegrity(uint256 poolId, uint256 agentId) public {
        ...
        emit PositionAgentRegistryFacet.AgentRegistered(tokenId, tba, agentId);
        vm.prank(owner);
