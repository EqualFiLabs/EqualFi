...
contract DirectTrancheAcceptancePropertyTest is DirectDiamondTestBase {
    ...
    function testProperty_AtomicTrancheAcceptance(
        ...
        uint256 agreementId = agreements.acceptOffer(offerId, borrowerPos, 0);
    ...
    function testProperty_EscrowToLentConsistency(
        ...
        vm.prank(borrowerOwner);
        agreements.acceptOffer(offerId, borrowerPos, 0);
    ...
    function test_AutoCancelPreservesUnrelatedEscrowInSamePool() public {
        ...
        vm.prank(borrowerOwner);
        uint256 agreementId = agreements.acceptOffer(trancheOfferId, borrowerPos, 0);
        ...
        vm.prank(borrowerOwner);
        uint256 ratioAgreementId = agreements.acceptRatioTrancheOffer(ratioOfferId, borrowerPos, 100 ether, 0);
