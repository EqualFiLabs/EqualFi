...
contract DirectRepayTimingPropertyTest is DirectDiamondTestBase {
    ...
    function testProperty_EarlyRepayTimingValidation() public {
        ...
        vm.prank(borrowerOwner);
        uint256 allowedAgreementId = agreements.acceptOffer(allowedOfferId, borrowerPositionId, 0);
        ...
        vm.prank(borrowerOwner);
        uint256 expiredAgreementId = agreements.acceptOffer(expiredOfferId, borrowerPositionId, 0);
