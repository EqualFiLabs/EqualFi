...
contract DirectComprehensiveIntegrationTest is DirectDiamondTestBase {
    ...
    function testIntegration_SettlementPathsAndFees() public {
        ...
        vm.prank(borrowerOwner);
        uint256 exerciseAgreementId = agreements.acceptOffer(exerciseOfferId, borrowerPos, 0);
        ...
        vm.prank(borrowerOwner);
        uint256 recoverAgreementId = agreements.acceptOffer(recoverOfferId, borrowerPos2, 0);
