...
contract DirectExercisePropertyTest is DirectDiamondTestBase {
    ...
    function testProperty_EarlyExerciseFunctionality() public {
        ...
        vm.prank(borrowerOwner);
        uint256 allowedAgreementId = agreements.acceptOffer(allowedOfferId, borrowerPositionId2, 0);
        ...
        vm.prank(borrowerOwner);
        uint256 lateAgreementId = agreements.acceptOffer(lateOfferId, borrowerPositionId2, 0);
